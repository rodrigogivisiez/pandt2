...
public class PlateActor extends Table {
    ...
    public PlateActor(Assets _assets, ChessActor chessActor) {
        ...
        _greenTile.setBackground(new TextureRegionDrawable(_assets.getGreenTile()));
        _greenTile.setFillParent(true);
        _greenTile.getColor().a = 0;
        this.addActor(_greenTile);

        _redTile = new Table();
        _redTile.setBackground(new TextureRegionDrawable(_assets.getRedTile()));
        _redTile.setFillParent(true);
        _redTile.setVisible(false);
        this.addActor(_redTile);

        Label.LabelStyle labelStyle = new Label.LabelStyle();
        labelStyle.font = _assets.getBlackNormal1Green();
    ...
    public void showBattle(){
        Image battleCloud = new Image(_assets.getBattleCloud());
        ...
        Image battleEffect = new Image(_assets.getBattleEffect());
    ...
    private void initializeArrows(){
        ...
        _arrowLeft = new Image(_assets.getArrowRight());
        ...
        _arrowRight = new Image(_assets.getArrowLeft());
        ...
        _arrowUp = new Image(_assets.getArrowDown());
        ...
        _arrowDown = new Image(_assets.getArrowUp());
