 ...
 */
public class GameStartingAnnouncement extends Announcement {
    ...
    public GameStartingAnnouncement(Services services) {
        ...
        labelBig = new Label(services.getTexts().gameStarting(), labelStyle1);
