...
public class TestCreateGame extends TestAbstract {
    ...
    public void testCreateGameLogicScene(){
        CreateGameLogic logic = new CreateGameLogic(mock(PTScreen.class), T_Assets.mockAssets());
    ...
    public void testGettingGames(){
        ...
        CreateGameLogic logic = new CreateGameLogic(mock(PTScreen.class), T_Assets.mockAssets(new MockDB()));
        CreateGameScene scene = (CreateGameScene) logic.getScene();
        logic.getAllGames();
