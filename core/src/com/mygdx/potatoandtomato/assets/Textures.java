...
public class Textures extends TextureAssets {
    ...
    public enum Name{
        ...
        COIN_WITH_ANGLE, COIN_FLAT, COIN_MACHINE_USERS_BG, NO_COIN_ICON_SMALL, COIN_ICON_SMALL, TOP_BAR_COIN_COUNT,
        FLOOR_BG, SHOP_ARCADE_WORLD, ARCADE_BG, SHOP_TABLE, POTATO_SUNGLASS, TOMATO_SUNGLASS,
        TOMATO_SUNGLASS_LEFT_HAND, TOMATO_SUNGLASS_RIGHT_HAND, PURSE_FRONT, PURSE_BACK,
        COIN_BAG, COIN_FIFTEEN, COIN_FIVE, COIN_ONE, PURSE_COIN_NORMAL, PURSE_COIN_SLEEP, OUT_OF_STOCK_ICON
