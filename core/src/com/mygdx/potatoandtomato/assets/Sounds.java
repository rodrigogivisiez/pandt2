...
public class Sounds extends SoundAssets {
    ...
    public enum Name{
        ...
        COIN_INSERTED, COIN_TO_SLOT, EIGHT_BIT_BUTTON_1, EIGHT_BIT_BUTTON_2,
        EIGHT_BIT_SPEAKING_POTATO, EIGHT_BIT_SPEAKING_TOMATO,
        COIN_PURCHASED, COIN_ADDING, WRONG, SWOOSH, EXTINGUISH_SOUND, NEXT_TUTORIAL, NOTIFICATION,
        PAGE_TURN, INBOX_NOTIFICATION
    }
}
