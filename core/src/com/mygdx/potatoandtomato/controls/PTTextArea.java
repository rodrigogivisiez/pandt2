...
/**
 * Created by SiongLeng on 13/8/2016.
 */
public class PTTextArea extends TextArea {

    private Assets assets;
    private boolean asciiOnly;

    public PTTextArea(Assets assets, boolean asciiOnly) {
        super("", new TextField.TextFieldStyle(assets.getFonts().get(Fonts.FontId.MYRIAD_M_REGULAR),
    ...
    public void setStyle(){
        TextField.TextFieldStyle textFieldStyle = this.getStyle();
